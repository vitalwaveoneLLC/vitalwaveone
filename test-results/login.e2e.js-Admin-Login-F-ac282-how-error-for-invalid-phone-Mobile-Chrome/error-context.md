...
- Name: login.e2e.js >> Admin Login Flow >> should show error for invalid phone
- Location: src\__tests__\e2e\login.e2e.js:26:3
...
Locator: locator('button:has-text("Send OTP")')
Expected: disabled
Timeout: 5000ms
